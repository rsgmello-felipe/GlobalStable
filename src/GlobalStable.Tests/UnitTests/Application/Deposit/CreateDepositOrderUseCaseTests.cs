...
public class CreateDepositOrderUseCaseTests
{
    ...
    public async Task ShouldSucceed_WhenAllDataIsValid(
        ...
        FeeConfig feeConfig,
        BgpCreateDepositResponse connectorResponse,
        long accountId,
        ...
        [Frozen] ILogger<CreateDepositOrderUseCase> logger)
    {
        ...
        connectorResponse = new BgpCreateDepositResponse
        {
        ...
        var baseApiResponse = new BaseApiResponse<BgpCreateDepositResponse>(connectorResponse);

        var apiResponse = new ApiResponse<BaseApiResponse<BgpCreateDepositResponse>>(
        ...
        A.CallTo(() => bgpConnectorClient.CreateDepositOrderAsync(A<BgpCreateDepositRequest>._))
            .Returns(apiResponse);
